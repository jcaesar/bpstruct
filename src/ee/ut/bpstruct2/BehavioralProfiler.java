...
public class BehavioralProfiler {
	...
	public BehavioralProfiler(Unfolding unf, Map<String, Node> tasks, Map<String, Node> clones) {
		this.unf = unf;
	...
	private void updateLabels(Map<String, Node> tasks,
			Map<String, Node> clones, Map<Integer, String> map) {
