...
public class RestructurerVisitor implements Visitor {
	...
	private void restructureCyclicRigid(final Graph graph, final Set<Edge> edges,
		...
		edges.clear(); vertices.clear();
		UnfoldingRestructurer restructurer = new UnfoldingRestructurer(unfhelper, new UnfoldingRestructurerVisitor(unfhelper, entry, tasks, labels, exit,
				instances, vertices, graph, edges));
...
//		System.exit(0);
	...
	private final class UnfoldingRestructurerVisitor implements Visitor {
		private final UnfoldingHelper unfhelper;
		private final Integer entry;
		private final Map<String, Integer> tasks;
		private final Map<String, Integer> labels;
		private final Integer exit;
		private final Map<Integer, Stack<Integer>> instances;
		...
		private UnfoldingRestructurerVisitor(UnfoldingHelper unfhelper,
				Integer entry, Map<String, Integer> tasks,
				Map<String, Integer> labels, Integer exit,
				Map<Integer, Stack<Integer>> instances, Set<Integer> vertices,
				Graph graph, Set<Edge> edges) {
